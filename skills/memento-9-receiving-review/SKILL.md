...
6. If blockers remain unresolved, loop back to appropriate earlier step (usually step 7, step 6 if tests are wrong, or `memento-2-planning` if the criterion is wrong).
