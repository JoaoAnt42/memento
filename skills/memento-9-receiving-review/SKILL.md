...
6. If blockers remain unresolved, loop back to appropriate earlier step (usually step 7 or step 6 if tests are wrong); a wrong criterion follows **Re-scope after approval** in `memento-4-human-review`.
